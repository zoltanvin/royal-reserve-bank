...
- Ensure that you have Java 17, Maven, Docker and a compatible IDE (such as [IntelliJ IDEA](https://www.jetbrains.com/idea/download/) or [Eclipse](https://www.eclipse.org/downloads/)) installed and properly configured.
...
- Ensure that you have Java 17, Docker and a compatible IDE (such as [IntelliJ IDEA](https://www.jetbrains.com/idea/download/) or [Eclipse](https://www.eclipse.org/downloads/)) installed and properly configured.
- Clone the repository and navigate to the project directory.
- Start the supporting services in Docker using Docker Compose by running the command `docker-compose docker-compose-infrastructure-services.yml up -d`.
...
- **Spring Cloud:** for implementing microservices architectural patterns, such as service discovery, configuration management and the circuit breaker.
- **Maven:** for managing dependencies and building the Java projects.
...
- Ensure that you have Prometheus running in Docker environment along with the microservices.
...
To set up Grafana with Prometheus as the data source and configure a dashboard, follow these steps:
...
I'm here to help! If you have any questions, feedback, or need assistance, please feel free to reach out to me. You can send me a message [here.](https://github.com/zoltanvin/royal-reserve-bank/discussions/new?category=q-a)
